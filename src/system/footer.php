...
#-Главная-#
    ...
    echo '<a href="/"><span style="float: center; width: 24%; display: inline-block;  padding-top: 3px; border-right: 1px dashed #4b4a4a;"><img src="/style/images/body/home_m.png" alt=""/></span></a>';
#-Герой-#
    echo "<a href='/hero/$user[id]'><span style='float: center;display: inline-block; width: 25%; padding-top: 3px; border-right: 1px dashed #4b4a4a;'><img src='/style/images/body/hero_m.png' alt=''/></span></a>";
#-Сумка-#
    echo "<a href='/bag'><span style='float: center;display: inline-block; width: 25%; padding-top: 3px;'><img src='/style/images/body/sumka_m.png' alt=''/></span></a>";
...
#-История клана-#
                ...
                if ($clan_c[0] != 0 or $clan_l[0] != 0) {
                    ...
                    $clan_m = '<img src="/style/images/body/clan_m.png" alt=""/>';
                }
                echo "<a href='/clan/view/$clan[id]'><span style='float: center;display: inline-block; width: 24%; padding-top: 3px; border-left: 1px dashed #4b4a4a;'>$clan_m</span></a>";
            }
        } else {
            echo "<a href='/clan'><span style='float: right; width: 25%; padding-top: 3px; border-left: 1px dashed #4b4a4a;'><img src='/style/images/body/clan_m.png' alt=''/></span></a>";
        }
    } else {
        echo "<span style='float: right; width: 25%; padding-top: 3px; border-left: 1px dashed #4b4a4a;'><img src='/style/images/body/clan_m.png' style='opacity: 0.3;' alt=''/></span>";
    }
    ...
    echo '<div class="user_foot">';
    echo "<img src='" . avatar_img_min($user['avatar'], $user['pol']) . "' class='img_users' width='50px' height='50px' alt=''/> <div class='user_foot_p'><img src='/style/images/user/user.png' alt=''/><span class='user_nick'>$user[nick]</span> <br/><img src='/style/images/user/level_2.png' alt=''/>$user[level] ур. <img src='/style/images/many/silver.png' alt=''/>" . num_format($user['silver']) . " <img src='/style/images/many/gold.png' alt=''/>" . num_format($user['gold']) . " <img src='/style/images/many/crystal.png' alt=''/>" . num_format($user['crystal']) . " </div>";
    echo '</div>';
    echo '<div class="line_1"></div>';
    echo '</div>';
    echo '</div>';
...
echo '
       <a class="lwhite nd small bold" href="/armors/runes">
       <div class="mt5 mb2 cntr"><img class="icon" src="/images/ico/art/blick-action.png?2"/></div>
       <div class="mb5 cntr">Акция на Руны –30%</div>
       </a><div class="cntr small mb5" style="color: #b280ff">До 10.11.2019 Включительно!!</div>
';
