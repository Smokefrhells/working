...
if($user['gold'] < $weapon['gold']){$color_g = '#ff0000';}else{$color_g = '#e6c4ad';}
#-Достаточно серебра или нет-#
if($user['silver'] < $weapon['silver']){$color_s = '#ff0000';}else{$color_s = '#e6c4ad';}
#-Достаточно праздничных монет или нет-#
if($user['snow'] < $weapon['snow']){$color_sn = '#ff0000';}else{$color_sn = '#e6c4ad';}
